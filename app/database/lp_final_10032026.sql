...
-- Tiempo de generación: 10-03-2026 a las 21:34:15
...
(5, 1, 3, 'Este es un comentario de prueba.', '2024-08-01 12:00:00');
...
(6, 1, 1, 1, 4999.99, '2026-02-26', '06:13:37');
...
(3, 'Matrix Resurrections', 'The Matrix', 136, '1999-03-31', 1, '2024-08-01', 'https://www.lamatrix.com', 'Un hacker descubre la verdad sobre su realidad y su papel en la guerra contra sus controladores.', 'matrix.jpg', 'Keanu Reeves, Laurence Fishburne', 'Ciencia Ficción', 'Estados Unidos', 'Español, Inglés', '+13'),
(4, 'Interestelar', 'Interstellar', 169, '2014-11-07', 1, '2026-02-18', 'https://www.interstellarmovie.net', 'Un grupo de exploradores viaja a través de un agujero de gusano para encontrar un nuevo hogar para la humanidad.', 'interestelar.jpg', 'Matthew McConaughey, Anne Hathaway, Jessica Chastain', 'Ciencia Ficción, Drama', 'Estados Unidos', 'Inglés, Español', '+13'),
(6, 'Amélie', 'Le Fabuleux Destin d\'Amélie Poulain', 122, '2001-04-25', 1, '2026-02-18', 'https://www.amelie-lefilm.com', 'Una joven parisina decide mejorar la vida de quienes la rodean.', 'amelie.jpg', 'Audrey Tautou, Mathieu Kassovitz', 'Comedia, Romance', 'Francia', 'Francés, Español', '8'),
(7, 'Amélie', 'Le Fabuleux Destin d\'Amélie Poulain', 122, '2001-04-25', 1, '2026-02-18', 'https://www.amelie-lefilm.com', 'Una joven parisina decide mejorar la vida de quienes la rodean.', 'amelie.jpg', 'Audrey Tautou, Mathieu Kassovitz', 'Comedia, Romance', 'Francia', 'Francés, Español', '8'),
(8, 'Amélie', 'Le Fabuleux Destin d\'Amélie Poulain', 122, '2001-04-25', 1, '2026-02-18', 'https://www.amelie-lefilm.com', 'Una joven parisina decide mejorar la vida de quienes la rodean.', 'amelie.jpg', 'Audrey Tautou, Mathieu Kassovitz', 'Comedia, Romance', 'Francia', 'Francés, Español', '8');
...
(4, '2026-03-03', '2026-03-11'),
(6, '2025-01-01', '2236-03-11');
...
INSERT INTO `usuarios` (`idUsuario`, `idPerfil`, `apellido`, `nombre`, `cuenta`, `estado`, `password`, `correo`, `resetPassword`) VALUES
(1, 1, 'Rasjido', 'Daniel', 'dani.rasjido', 1, '$2y$10$hash_admin', 'admin@cine.com', 0),
(2, 2, 'Gomez', 'Laura', 'lauri.gomez', 1, '$2y$10$hash_operador', 'operador@cine.com', 0),
(3, 3, 'Perez', 'Juan', 'juanceto01', 1, '$2y$10$hash_cliente', 'cliente1@gmail.com', 0),
(4, 3, 'Lopez', 'Maria', 'marita', 1, '$2y$10$hash_cliente', 'cliente2@gmail.com', 0),
(6, 2, 'Perez', 'Tomás', 'tommy.perez', 1, '$2y$10$c5Yl8hLrsNtrE6zfDOCl3ukldhw9m7Q3JlYkpwMp81MWe9SnhFkuW', 'tomasito.perez@test.com', 0),
(10, 3, 'Camila', 'Aballay', 'pinkipai', 1, '$2y$10$nbdT9hGJ7nFWgpHvE/9UF.56FY2a3rqRHhU4O1xPD6QNw2eDEiHR.', 'cami_uwu@gmail.com', 0),
(11, 3, 'Yuji', 'Itadori', 'yuji10', 1, '$2y$10$W5YFQyJt7IUBo.QT1aU6geQdMbV80X639eivLzJ8ogWayU1lnHKmy', 'itadori@gmail.com', 0),
(13, 3, 'Villegas', 'Emiliano', 'emi19', 1, '$2y$10$NsPeoVHO3.1mK8xoxPK65e3uIKRrZ7QF/giKXgez8eDLfrbPTTGq.', 'emi@gmail.com', 0);
...
--
ALTER TABLE `programacion`
  MODIFY `idProgramacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
